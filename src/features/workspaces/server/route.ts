...
const app = new Hono()
  ...
  .delete("/:workspaceId", sessionMiddaleware, async (c) => {
    const databases = c.get("databases");
    const user = c.get("user");
  ...
  .get("/:workspaceId", sessionMiddaleware, async (c) => {
    const databases = c.get("databases");
    const user = c.get("user");
    const { workspaceId } = c.req.param();
  ...
  .get("/:workspaceId/info", sessionMiddaleware, async (c) => {
    const databases = c.get("databases");
    const user = c.get("user");
    const { workspaceId } = c.req.param();
  ...
  .get("/:workspaceId/analytics", sessionMiddaleware, async (c) => {
    const databases = c.get("databases");
    const user = c.get("user");
    const { workspaceId } = c.req.param();
